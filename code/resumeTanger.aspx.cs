...
namespace hotelerie
{
    public partial class resumeTanger : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblHotel.Text = "Luxury Hotel Tanger";
                lblDevise.Text = Convert.ToString(Session["Devise"]);
                lblType.Text = Convert.ToString(Session["TypeChambre"]);
                ...
                lblRace.Text = Convert.ToString(Session["RaceAnimal"]);
                lblDimensions.Text = Convert.ToString(Session["DimensionsAnimal"]);
                lblPasseport.Text = Convert.ToString(Session["PasseportAnimal"]);
            }
        }
        ...
        protected void btnConfirmer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string message = "Nouvelle réservation : " + type + " à Tanger du " +
